...
namespace Catalog.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ...
            ViewBag.ListaDatosCliente = _bl.ConsultarDatosCliente().ToList();
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ActualizarDatos(ManageUserViewModel pEN)
        {
            _bl.ActualizarDatos(pEN);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ActualizarClave(ManageUserViewModel pEN)
        {
            _bl.ActualizarClave(pEN);
            return RedirectToAction("Manage", "Account");
